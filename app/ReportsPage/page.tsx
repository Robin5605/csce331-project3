      ...
      <div className="mx-auto max-w-6xl space-y-8">
        <header>
          ...
          <p className="mt-1 text-sm text-slate-500">
            View product sales, inventory usage, and restock recommendations.
          </p>
        </header>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div className="flex flex-col rounded-lg border border-slate-200 bg-white p-4 shadow-sm">
            ...
            <div className="mb-4 flex flex-wrap items-center gap-3 text-sm">
              <div className="flex items-center gap-2">
                <label htmlFor="salesStart" className="text-slate-600">
                  Start
                </label>
                <input
                  id="salesStart"
              ...
              <div className="flex items-center gap-2">
                <label htmlFor="salesEnd" className="text-slate-600">
                  End
                </label>
                <input
                  id="salesEnd"
          ...
          <div className="flex flex-col rounded-lg border border-slate-200 bg-white p-4 shadow-sm">
            ...
            <div className="mb-4 flex flex-wrap items-center gap-3 text-sm">
              <div className="flex items-center gap-2">
                <label htmlFor="usageStart" className="text-slate-600">
                  Start
                </label>
                <input
                  id="usageStart"
              ...
              <div className="flex items-center gap-2">
                <label htmlFor="usageEnd" className="text-slate-600">
                  End
                </label>
                <input
                  id="usageEnd"
        ...
        <section className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="rounded bg-blue-600 px-3 py-1.5 text-sm font-medium text-white hover:bg-blue-700"
            >
              {isRestockLoading ? "Generating..." : "Generate Restock Report"}
            </button>
          </div>
              ...
              <tbody>
                {restockData.length === 0 ? (
                  <tr>
                    ...
                    >
                      No data yet. Click &quot;Generate&quot; to load the
                      restock report.
                    </td>
                  </tr>
                ) : (
                  restockData.map((row) => (
                    ...
                    >
                      <td className="px-4 py-2">{row.ingredientName}</td>
